export default function DashboardPage() {
	return (
		<div className="space-y-6">
			<div>
				<h2 className="text-2xl font-bold text-gray-900">Welcome to FinOps for AI</h2>
			...
			<div className="rounded-lg border-2 border-dashed border-gray-300 p-12">
				<div className="text-center">
					...
					<h3 className="mt-2 text-sm font-semibold text-gray-900">No cost data yet</h3>
					<p className="mt-1 text-sm text-gray-500">
						비용 데이터가 아직 없습니다. API 키를 설정하고 비용 수집을 시작하세요.
					</p>
					<div className="mt-6">
						<button
							type="button"
			...
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
				<div className="rounded-lg bg-white px-4 py-5 shadow sm:p-6">
					<dt className="truncate text-sm font-medium text-gray-500">Total Cost (MTD)</dt>
					<dd className="mt-1 text-3xl font-semibold tracking-tight text-gray-900">$0.00</dd>
				</div>
				<div className="rounded-lg bg-white px-4 py-5 shadow sm:p-6">
